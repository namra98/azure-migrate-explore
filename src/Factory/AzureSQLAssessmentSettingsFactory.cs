...
namespace Azure.Migrate.Explore.Factory
{
    ...
    {
        public List<AssessmentInformation> GetAzureSQLAssessmentSettings(UserInput userInputObj, string assessmentType, List<string> scopedMachineIds)
        {
            ...
            userInputObj.LoggerObj.LogInformation($"Obtaining Azure SQL assessment settings for assessment type {assessmentType}");

            if (assessmentType.Contains("Prod"))
                result = GetAzureSQLProdAssessmentSettings(userInputObj, scopedMachineIds);

            else if (assessmentType.Contains("Dev"))
                result = GetAzureSQLDevAssessmentSettings(userInputObj, scopedMachineIds);

            if (result.Count <= 0)
                throw new Exception($"Azure SQL assessment factory provided no settings for assessment type {assessmentType}.");
        ...
        private List<AssessmentInformation> GetAzureSQLProdAssessmentSettings(UserInput userInputObj, List<string> scopedMachineIds)
        {
            ...
            obj1.Properties.Settings.EnvironmentType = "Production";
            ...
            obj1.Properties.Settings.OSLicense = "No";
            obj1.Properties.Settings.SQLServerLicense = "No";
            result.Add(new AssessmentInformation("SQL-Prod-AzMigExport-1", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased, JsonConvert.SerializeObject(obj1)));
            ...
            obj2.Properties.Settings.EnvironmentType = "Production";
            obj2.Properties.Settings.SavingsSettings.SavingsOption = "RI3Year";
            ...
            obj2.Properties.Settings.OSLicense = "No";
            obj2.Properties.Settings.SQLServerLicense = "No";
            result.Add(new AssessmentInformation("SQL-Prod-AzMigExport-2", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased_RI3year, JsonConvert.SerializeObject(obj2)));
            ...
            obj3.Properties.Settings.EnvironmentType = "Production";
            ...
            obj3.Properties.Settings.OSLicense = "Yes";
            obj3.Properties.Settings.SQLServerLicense = "Yes";
            result.Add(new AssessmentInformation("SQL-Prod-AzMigExport-3", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased_AHUB, JsonConvert.SerializeObject(obj3)));
            ...
            obj4.Properties.Settings.EnvironmentType = "Production";
            obj4.Properties.Settings.SavingsSettings.SavingsOption = "RI3Year";
            ...
            obj4.Properties.Settings.OSLicense = "Yes";
            obj4.Properties.Settings.SQLServerLicense = "Yes";
            result.Add(new AssessmentInformation("SQL-Prod-AzMigExport-4", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased_AHUB_RI3year, JsonConvert.SerializeObject(obj4)));
            ...
            obj5.Properties.Settings.EnvironmentType = "Production";
            obj5.Properties.Settings.SavingsSettings.SavingsOption = "None";
            ...
            obj5.Properties.Settings.OSLicense = "Yes";
            obj5.Properties.Settings.SQLServerLicense = "Yes";
            result.Add(new AssessmentInformation("SQL-Prod-AzMigExport-5", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased_ASP3year, JsonConvert.SerializeObject(obj5)));

            return result;
        }

        private List<AssessmentInformation> GetAzureSQLDevAssessmentSettings(UserInput userInputObj, List<string> scopedMachineIds)
        {
            var ScopeDetails = new ScopeDetails();
            if (scopedMachineIds != null && scopedMachineIds.Any())
            {
            ...
            obj1.Properties.Settings.OSLicense = "No";
            obj1.Properties.Settings.SQLServerLicense = "No";
            result.Add(new AssessmentInformation("SQL-Dev-AzMigExport-1", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased, JsonConvert.SerializeObject(obj1)));
            ...
            obj2.Properties.Settings.Currency = userInputObj.Currency.Key;
            obj2.Properties.Settings.PerformanceData.TimeRange = userInputObj.AssessmentDuration.Key;
            obj2.Properties.Settings.OSLicense = "Yes";
            obj2.Properties.Settings.SQLServerLicense = "Yes";
            result.Add(new AssessmentInformation("SQL-Dev-AzMigExport-2", AssessmentType.SQLAssessment, AssessmentTag.PerformanceBased_AHUB, JsonConvert.SerializeObject(obj2)));
